...
Test Template   Add Invalid New User to OrangeHRM

*** Test Cases ***    UserRole    UserStatus    EmployeeName    EmployeeUsername    Password    ConfirmPassword    ErrorMsg
...
*** Keywords ***
Add Invalid New User to OrangeHRM
