...
integer_only_password='12345678910'
...
alphabet_password_error_message='Your password must contain minimum 1 lower-case letter'
integer_password_error_message='Your password must contain minimum 1 number'
